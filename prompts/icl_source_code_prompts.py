"""This prompt was used for full source code setting"""
...
source_code_prompts_v3_detailed = """You are a COBOL and software programming expert. For a given variable, generate the following (in English):
...
[
  {
    ...
    "long description": "concise phrase (strictly in English) aggregated from all variable occurrences, capturing its purpose, business semantics, and interaction-driven implications, while remaining faithful to the code"
  }
]

Context
Analyze all the variable occurrences given in the source code to understand the variable's role, business logic, and interaction-driven implications.
...
5. The long description must:
    a) reflect insights aggregated from all occurrences of the variable
